    ...
    stats.map((row) => {
        if (tankNames[row.tank_id] || oldtanksNames[row.tank_id]) {
            ...
            let vehicleStats = {
                ...
                awards: {
                    battleHeroes: {
                        highCaliber: MOEstats[counter].achievements.mainGun || 0,
                        topGun: MOEstats[counter].achievements.warrior || 0,
                        confederate: MOEstats[counter].achievements.supporter || 0,
                        tankSniper: MOEstats[counter].achievements.sniper2 || 0,
                        steelWall: MOEstats[counter].achievements.steelwall || 0,
                        defender: MOEstats[counter].achievements.defender || 0,
                        invader: MOEstats[counter].achievements.invader || 0,
                        scout: MOEstats[counter].achievements.scout || 0,
                        patrolDuty: MOEstats[counter].achievements.evileye || 0
                    },
                    main: {
                        fireForEffect: MOEstats[counter].achievements.shootToKill || 0,
                        duelist: MOEstats[counter].achievements.duelist || 0,
                        fighter: MOEstats[counter].achievements.fighter || 0,
                        shellproof: MOEstats[counter].achievements.impenetrable || 0,
                        kamikaze: MOEstats[counter].achievements.kamikaze || 0,
                        spotter: MOEstats[counter].achievements.aimer || 0,
                        reaper: MOEstats[counter].achievements.handOfDeath || 0,
                        masterGunner: MOEstats[counter].achievements.armorPiercer || 0,
                        sharpShooter: MOEstats[counter].achievements.titleSniper || 0
                    },
                    epic: {
                        billotte: MOEstats[counter].achievements.medalBillotte || 0,
                        bruno: MOEstats[counter].achievements.medalBrunoPietro || 0,
                        burda: MOEstats[counter].achievements.medalBurda || 0,
                        delanglade: MOEstats[counter].achievements.medalDeLanglade || 0,
                        dumitru: MOEstats[counter].achievements.medalDumitru || 0,
                        fadin: MOEstats[counter].achievements.medalFadin || 0,
                        gore: MOEstats[counter].achievements.medalGore || 0,
                        halonen: MOEstats[counter].achievements.medalHalonen || 0,
                        kolobanov: MOEstats[counter].achievements.medalKolobanov || 0,
                        lehvaslaiho: MOEstats[counter].achievements.medalLehvaslaiho || 0,
                        naydin: MOEstats[counter].achievements.huntsman || 0,
                        nicol: MOEstats[counter].achievements.medalNikolas || 0,
                        orlik: MOEstats[counter].achievements.medalOrlik || 0,
                        oskin: MOEstats[counter].achievements.medalOskin || 0,
                        pascucci: MOEstats[counter].achievements.medalPascucci || 0,
                        pool: MOEstats[counter].achievements.medalLafayettePool || 0,
                        radley: MOEstats[counter].achievements.medalRadleyWalters || 0,
                        raseiniai: MOEstats[counter].achievements.heroesOfRassenay || 0,
                        stark: MOEstats[counter].achievements.medalStark || 0,
                        tamada: MOEstats[counter].achievements.medalTamadaYoshio || 0,
                        tarczay: MOEstats[counter].achievements.medalTarczay || 0
                    }
                }
            };
